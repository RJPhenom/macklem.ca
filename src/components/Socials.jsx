	...
	return (
		<div className="flex flex-row gap-6 text-xl justify-center rounded-full py-0 xs:py-2">
			<a
				...
				className="rounded-full transition text-slate-700 transform hover:scale-110 p-1"
			>
				<FaGithub />
			</a>
			...
			<a
				...
				className="rounded-full transition text-blue-400 transform hover:scale-110 p-1"
			>
				<FaBluesky />
			</a>
			...
			<a
				...
				className="rounded-full transition text-black transform hover:scale-110 p-1"
			>
				<FaXTwitter />
			</a>
			...
			<a
				...
				className="rounded-full transition text-blue-500 transform hover:scale-110 p-1"
			>
				<FaLinkedin />
			</a>
		</div>
